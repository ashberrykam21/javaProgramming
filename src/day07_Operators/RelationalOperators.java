...
public class RelationalOperators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("rboolean result4 = esult3 = " + result3);
        ...
        int creditScore = 745;
        boolean isEligibleForLoan = creditScore >= 720;//if the credit score is 720 or greater u r eligible for credit
