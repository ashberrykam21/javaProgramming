...
public class MyOffer {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("VA", "Microsoft", "SDET", 150000, true, true, true, true);

        Offer offer2 = new Offer();
        offer2.setInfo("California", "Sony Inc", "QA", 120000, true, false, false, false);

        Offer offer3 = new Offer();
        offer3.setInfo("Florida", "Apple Inc", "QE", 135000, true, true, true, true);


        Offer offer4 = new Offer();
        offer4.setInfo("TX", "Capital One", "SM", 115000, false, false, true, false);
