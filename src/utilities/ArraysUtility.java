...
public class ArraysUtility {
    ...
    // prints all integer of an integer array in separate lines
    ...
    //returns maximum number from integer array
    ...
    //returns maximum number from double array
    ...
    //returns minimum number from integer array
    ...
    public static boolean contains(int[] array, int element) {
        ...
        for (int each : array) {
            if (each == element) {// if any array's element is matching with the given element, it means the given element contained in the array
                result = true;
            }
        }
        return result;
    ...
    public static int[] uniqueElements(int[] array) {
        int[] result = {};
        for (int each : array) {
            if (ArraysUtility.frequencyOfElement(array, each) == 1) {//if the frequency is 1 then element is unique
    ...
    public static int[] removeElement(int[] array, int index){
        ...
        if(index<0 || index> array.length-1){ System.err.println("Invalid Index"+ index);
            System.exit(0);
        }
        int[] result = new int[array.length-1];
    ...
    //replace the element of the array at given index with new element
