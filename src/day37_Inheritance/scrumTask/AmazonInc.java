...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        ProductOwner po = new ProductOwner("Suhaib",29,'M',160000,1, company);

        BusinessAnalyst ba = new BusinessAnalyst("Elen",30,'F',2,150000,company);
        ScrumMaster sm = new ScrumMaster("Asya",25,'F',"SM",3,145000, company);
