...
public class UniqueElements {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> unique2 = new ArrayList<>(list2);//adds all the elements of list2

       unique2.removeIf(p -> Collections.frequency(list2 ,p)>1);//removes all duplicated elements
                                                     //p represents each element of list2
