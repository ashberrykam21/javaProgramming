...
public class NumberOfDays {
    ...
    public static void main(String[] args) {
      ...
      boolean has30Days = number ==4 || number ==6 || number ==9 || number == 11;//for the months that 30 days
      boolean has31Days = !has28Days && !has30Days; //if the month doesnot have 28 days and does not have 30.
